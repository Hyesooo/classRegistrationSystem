...
<%
	...
	int c_maxppl = Integer.parseInt(request.getParameter("c_maxppl"));
	...
	stmt.setInt(3, c_div);
	stmt.setInt(4, c_credit);
	stmt.setInt(5, c_hour);
	stmt.setString(6, c_day);
	stmt.setInt(7, c_year);
	stmt.setInt(8, c_sem);
	stmt.setInt(9, c_maxppl);
	stmt.setString(10, c_where);
	stmt.setString(11, a_id);
	stmt.registerOutParameter(12, oracle.jdbc.OracleTypes.VARCHAR);
	stmt.execute();
